...
**Primeiro de tudo:** você precisa de um gerenciador de pacotes, como o [NPM](https://www.npmjs.com/) ou [YARN](https://classic.yarnpkg.com/lang/en/docs/install/#windows-stable). Você também vai precisar do [Docker](https://www.docker.com/get-started/).
